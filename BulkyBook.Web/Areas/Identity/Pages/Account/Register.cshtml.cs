...
namespace BulkyBook.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            ViewData["Companies"] = new SelectList(_unitOfWork.Company.GetAll(), "Id", "Name");
        }
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        var role = _roleManager.FindByIdAsync(Input.Role);
                    ...
                    else
                    {
                        ...
                        {
                            TempData["success"] = "New User Create Succesfully";
                        }
                        else
                        {
